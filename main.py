...
@dp.callback_query(F.data == 'state_search')
...
@dp.message(Operation.waiting_for_article_selection)
...
@dp.callback_query(Operation.waiting_for_article_selection, F.data.startswith("article_"))
...
@dp.callback_query(Operation.waiting_for_article_selection, F.data == "back_to_articles_list")
...
@dp.callback_query(Operation.waiting_for_article_selection, F.data == "back_to_news_search")
