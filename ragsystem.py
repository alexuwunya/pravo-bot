    ...
    async def answer_question(self, question):
        try:
            ...
            system_prompt = (
                ...
                "Отвечай кратко, понятно для детей, упрощая некоторые сложные аспекты. Оптимальная длина ответа 150-300 символов"
                "Отвечай ТОЛЬКО На РУССКОМ языке, никогда не используй латиницу"
